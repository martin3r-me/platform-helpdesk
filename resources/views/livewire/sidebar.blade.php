...
<div x-data="{ collapsed: false }">
    {{-- Modul Header --}}
    <div class="px-4 py-2.5 text-[11px] font-medium text-[color:var(--ui-muted)] uppercase tracking-wider border-b border-[color:var(--ui-border)]">
        Helpdesk
    </div>

    {{-- Abschnitt: Allgemein --}}
    <div class="mt-2">
        <h4 class="px-4 py-2 text-[11px] tracking-wider font-semibold text-[color:var(--ui-muted)] uppercase">Allgemein</h4>

        {{-- Dashboard --}}
        <a href="{{ route('helpdesk.dashboard') }}"
           class="relative flex items-center mx-2 px-2.5 py-1.5 rounded-md text-[13px] transition gap-2.5"
           :class="(
               ...
               ? 'bg-[color:var(--ui-primary)] text-[color:var(--ui-on-primary)] font-medium'
               : 'text-[color:var(--ui-secondary)] hover:bg-[color:var(--ui-muted-10)] hover:text-[color:var(--ui-primary)]'"
           wire:navigate>
            <x-heroicon-o-chart-bar class="w-[18px] h-[18px] flex-shrink-0"/>
        ...
        <a href="{{ route('helpdesk.my-tickets') }}"
           ...
           :class="(
               ...
               : 'text-[color:var(--ui-secondary)] hover:bg-[color:var(--ui-muted-10)] hover:text-[color:var(--ui-primary)]'"
           wire:navigate>
            <x-heroicon-o-home class="w-[18px] h-[18px] flex-shrink-0"/>
        ...
        <a href="{{ route('helpdesk.slas.index') }}"
           ...
           :class="(
               ...
               : 'text-[color:var(--ui-secondary)] hover:bg-[color:var(--ui-muted-10)] hover:text-[color:var(--ui-primary)]'"
           wire:navigate>
            <x-heroicon-o-clock class="w-[18px] h-[18px] flex-shrink-0"/>
            <span class="truncate">SLA-Verwaltung</span>
        </a>

        {{-- Helpdesk Board anlegen --}}
        <a href="#"
           class="relative flex items-center mx-2 px-2.5 py-1.5 rounded-md text-[13px] text-[color:var(--ui-secondary)] hover:bg-[color:var(--ui-muted-10)] hover:text-[color:var(--ui-primary)] transition gap-2.5"
           wire:click="createHelpdeskBoard">
            <x-heroicon-o-plus class="w-[18px] h-[18px] flex-shrink-0"/>
    ...
    <div class="mt-4">
        <h4 class="px-4 py-2 text-[11px] tracking-wider font-semibold text-[color:var(--ui-muted)] uppercase">Helpdesk Boards</h4>
        ...
        @foreach($helpdeskBoards as $board)
            <a href="{{ route('helpdesk.boards.show', ['helpdeskBoard' => $board]) }}"
               ...
               wire:navigate>
                <x-heroicon-o-folder class="w-[18px] h-[18px] flex-shrink-0"/>
